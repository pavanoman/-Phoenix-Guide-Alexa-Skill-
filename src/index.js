...
var HelpMessage = "Here are some things you  can say: Give me an attraction. Tell me about " + location + ". Tell me the top five things to do and say stop to end the session .What would you like to do?";

var moreInformation = "See your  Alexa app for  more  information or say stop to end the session or say help for guidlines."

var tryAgainMessage = "please try again."

var noAttractionErrorMessage = "There was an error finding this attraction, " + tryAgainMessage;

var topFiveMoreInfo = "See your  Alexa app for  more  information or say stop to end the session or say help for guidlines. ";
...
var newSessionHandlers = {
    'LaunchRequest': function () {
     ...
     'getOverview': function () {
        ...
        this.emit(':askWithCard', output,output);
    },
...
var startSearchHandlers = Alexa.CreateStateHandler(states.SEARCHMODE, {
    ...
    'getAttractionIntent': function () {
        ...
        if (attraction) {
            ...
            this.emit(':askWithCard', output, cardTitle, cardContent,output);
        } else {
